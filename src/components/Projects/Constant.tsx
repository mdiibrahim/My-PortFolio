export const projects = [
  {
    ...
    server_code_link: "https://github.com/mdiibrahim/PoshFoods-Server", // New server-side link
    demo_link: "https://poshfoods.vercel.app/",
    technologies: [
      "NextJs",
      "React",
      "Node.js",
  ...
  },
  {
    ...
    server_code_link: "https://github.com/mdiibrahim/PoshTurf-Server", // New server-side link
    demo_link: "https://poshturf-client.vercel.app/",
    technologies: ["React", "TypeScript", "Node.js", "Express", "MongoDB"], // Technologies used
  },
  {
    name: "TukiTaki",
    description:
    ...
    server_code_link: "https://github.com/mdiibrahim/Tukitaki-Server", // New server-side link
    demo_link: "https://tukitakibyrhidy.web.app/",
    technologies: ["React", "Node.js", "Express", "MongoDB", "Firebase"], // Technologies used
  },
  {
    name: "Code for Chill",
    description:
    ...
    server_code_link: "https://github.com/mdiibrahim/Code-for-Chill-Server", // New server-side link
    demo_link: "https://code-for-chill.web.app/",
    technologies: ["React", "Node.js", "Express", "MongoDB", "TailwindCSS"], // Technologies used
  },
  {
    ...
    source_code_link:
      "https://github.com/mdiibrahim/Skin-Cancer-Prediction-App-With-ML",
    server_code_link: null,
    demo_link:
      "https://drive.google.com/file/d/13DBY5qryR2AI9MsJE6wEjfCiiybUFEeW/view?usp=sharing",
    technologies: ["Python", "TensorFlow", "Google Colab", "Flask"],
  },
];
